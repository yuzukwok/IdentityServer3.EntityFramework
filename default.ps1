...
task CreateNuGetPackage -depends Compile {
  ...
  copy-item $src_directory\IdentityServer3.EntityFramework.MySql.nuspec $dist_directory
  copy-item $output_directory\IdentityServer3.EntityFramework.MySql.dll $dist_directory\lib\net45
  copy-item $output_directory\IdentityServer3.EntityFramework.MySql.pdb $dist_directory\lib\net45
  
	exec { . $nuget_path pack $dist_directory\IdentityServer3.EntityFramework.MySql.nuspec -BasePath $dist_directory -o $dist_directory -version $packageVersion }
}
